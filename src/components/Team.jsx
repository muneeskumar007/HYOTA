...
const team = [
  {
    ...
    bio: 'Healthcare strategist with a passion for making clinical workflows human-centered.',
  },
  {
    name: 'Priya Nair',
    ...
    bio: 'Product thinker with deep roots in UX design and healthcare operations.',
  },
  {
    name: 'Karthik Rajan',
    role: 'Lead Developer',
