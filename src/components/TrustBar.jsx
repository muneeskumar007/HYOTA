...
const items = [
  ...
  { icon: Building2, label: 'Hospital Ready', desc: 'Built for clinical workflows', color: 'text-teal-600', bg: 'bg-teal-50' },
  { icon: Smartphone, label: 'Mobile First', desc: 'Designed for on-the-go', color: 'text-violet-600', bg: 'bg-violet-50' },
];
