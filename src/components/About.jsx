        ...
        <div className="grid grid-cols-2 gap-6 md:gap-12 lg:gap-24">
          ...
          <div className="w-full">
            ...
            <div className="text-center mb-10 md:mb-14">
              ...
              {/* IMPORTANT FIX */}
              <p className="text-gray-500 text-sm md:text-lg leading-relaxed max-w-[500px] mx-auto min-h-[90px] md:min-h-[120px] flex items-center justify-center">
                Disconnected systems force patients to waste time,
                energy, and attention on logistics instead of recovery.
              </p>
            </div>
            ...
            <div className="flex flex-col">
              {problems.map((item) => (
                ...
                >
                  ...
                  <p className="text-gray-700 text-xs md:text-base leading-relaxed w-full">
                    {item}
                  </p>
                </div>
              ))}
